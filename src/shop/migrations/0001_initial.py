    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_front', models.ImageField(blank=True, null=True, upload_to=shop.utils.front_image, verbose_name='正面图片')),
                ('image_back', models.ImageField(blank=True, null=True, upload_to=shop.utils.back_image, verbose_name='背面图片')),
